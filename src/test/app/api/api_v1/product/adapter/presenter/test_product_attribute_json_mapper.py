...
class TestProductAttributeJsonMapper:
    mapper: Mapper = ProductAttributeJsonMapper()

    def test_map_to_domain_correct_instantiation(
        self, product_attribute_req: ProductAttributeRequest
    ):
    ...
    def test_map_from_domain(self, product_attribute: ProductAttribute):
        product_attr_res: ProductAttributeResponse = self.mapper.map_from_domain(
            product_attribute
        )
