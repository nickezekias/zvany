...
class User(Entity):
    ...
    def __init__(
        ...
        self.ID_document = ID_document  # TODO: Implement verification algorithm
            ...
            self.errors.append(
                {
                    "type": "str",
                    "loc": "User, first_name",
                    "msg": "Attribute must be str and have at least 3 characters",
    ...
    def validate_last_name(self) -> None:
        if (
            not isinstance(self.last_name, str)
            or not self.last_name
            or not len(self.last_name) >= 3
        ):
            self.errors.append(
                {
                    "type": "str",
            ...
            self.errors.append(
                {
                    "type": "str",
                    "loc": "User, email",
                    "msg": "Attribute must be non-empty str and a valid email",
                    "input": self.email,
                }
            )
            ...
            self.errors.append(
                {
                    "type": "str",
                    "loc": "User, phone",
                    "msg": "Attribute must be non-empty str",
                    "input": self.phone,
                }
            )
            ...
            self.errors.append(
                {
                    "type": "str",
                    "loc": "User, password",
                    "msg": "Attribute must be str and have at least 8 characters",
                    "input": self.password,
                }
            )

    def validate_email_verified_at(self) -> None:
        if not self.email_verified_at == None and not DateTimeUtil.is_valid_date(
            self.email_verified_at
        ):
            self.errors.append(
                {
                    "type": "datetime | None",
                    "loc": "User, email_verified_at",
                    "msg": "Attribute must be 'None' or a valid date",
                    "input": self.email_verified_at,
                }
            )

    def validate_phone_verified_at(self) -> None:
        if not self.phone_verified_at == None and not DateTimeUtil.is_valid_date(
            self.phone_verified_at
        ):
            self.errors.append(
                {
                    "type": "datetime | None",
                    "loc": "User, phone_verified_at",
                    "msg": "Attribute must be 'None' or a valid date",
                    "input": self.phone_verified_at,
                }
            )

    def validate_ID_document_verified_at(self) -> None:
        if not self.ID_document_verified_at == None and not DateTimeUtil.is_valid_date(
            self.ID_document_verified_at
        ):
            self.errors.append(
                {
                    "type": "datetime | None",
                    "loc": "User, ID_document_verified_at",
                    "msg": "Attribute must be 'None' or a valid date",
                    "input": self.ID_document_verified_at,
                }
            )
            ...
            self.errors.append(
                {
                    "type": "bool",
                    "loc": "User, is_active",
                    "msg": "Attribute must be bool",
                    "input": self.is_active,
                }
            )
